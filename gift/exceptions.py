...
class MathAnswerValueError(AnswerException): pass

class TrueFalseValueError(AnswerException): pass

class ChoiceAnswerValueError(AnswerException): pass

class MissingWordAnswerValueError(AnswerException): pass

class MatchingAnswerValueError(AnswerException): pass
